...
@section('pageSpecificContent')
    ...
    <section class="xs-banner-inner-section parallax-window"
             style="background-image:url('assets/images/backgrounds/team_bg.jpg')">
        ...
        <div class="container">
            <div class="color-white xs-inner-banner-content">
                ...
                <ul class="xs-breadcumb">
                    <li class="badge badge-pill badge-primary"><a href="index.html" class="color-white"> Home /</a> Team
                    </li>
                </ul>
            </div>
        </div>
        ...
        <section class="bg-navy-blue xs-section-padding">
            <div class="container-fulid">
                <div class="xs-feature-content-v2">
                    <h2 class="color-white">CharityPress are <span> charity </span> activities are taken place around
                        the world, lets contribute.</h2>
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="xs-partner-content">
                            ...
                            <p>In-kind donations from our donors and partners allow charity: water to pass 100% of
                                public donations straight to water projects. We are deeply grateful for those who have
                                surprised us with their generosity. A big thanks to the following companies and people
                                who have helped make charity: water’s work possible.</p>
